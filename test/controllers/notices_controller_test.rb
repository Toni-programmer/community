...
class NoticesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create notice" do
    assert_difference("Notice.count") do
      post notices_url, params: { notice: { community_id: @notice.community_id, concept: @notice.concept, name: @notice.name } }
    end
  ...
  test "should update notice" do
    patch notice_url(@notice), params: { notice: { community_id: @notice.community_id, concept: @notice.concept, name: @notice.name } }
