...
class CommunitiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create community" do
    assert_difference("Community.count") do
      post communities_url, params: { community: { adress: @community.adress, bank_account: @community.bank_account, cif: @community.cif, name: @community.name } }
    end
  ...
  test "should update community" do
    patch community_url(@community), params: { community: { adress: @community.adress, bank_account: @community.bank_account, cif: @community.cif, name: @community.name } }
