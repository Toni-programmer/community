...
class IncidencesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create incidence" do
    assert_difference("Incidence.count") do
      post incidences_url, params: { incidence: { community_id: @incidence.community_id, date: @incidence.date, description: @incidence.description, photo: @incidence.photo, status: @incidence.status, user_id: @incidence.user_id } }
    end
  ...
  test "should update incidence" do
    patch incidence_url(@incidence), params: { incidence: { community_id: @incidence.community_id, date: @incidence.date, description: @incidence.description, photo: @incidence.photo, status: @incidence.status, user_id: @incidence.user_id } }
